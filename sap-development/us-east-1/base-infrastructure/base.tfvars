...
## Public Subnet
public_subnets = {
  "us-east-1a" = "10.150.0.192/27"
  "us-east-1b" = "10.150.0.224/27"
}
...
## Private Subnets
private_subnets = {
  "us-east-1a" = "10.150.0.0/26"
  "us-east-1b" = "10.150.0.64/26"
}
...
#    "10.4.0.0/22", "10.105.0.0/22", "10.6.1.0/24",
#    "10.7.0.0/22", "10.8.0.0/22", "10.50.0.0/24"
#    ]
...
sap_security_groups = [
  {
    ...
    sap_base_prefix : [],
    sap_control_cidr : ["10.150.0.0/25", "10.150.12.0/25"],
    sap_control_prefix : [],
  ...
  },
  {
    ...
    is_scs : true,
    enable_sap_standard_http : true,
    sap_base_cidr : ["10.150.0.0/25", "10.150.12.0/25"],
    sap_base_prefix : [],
    sap_control_cidr : ["10.150.0.0/25", "10.150.12.0/25"],
    sap_control_prefix : [],
    sap_router_sysnr : "3299"
