...
variable "lb_name" {
  description = "Load balancer name, will be used as part of the AWS generatred hostname."
  type        = string
  default     = null
}
...
variable "internal" {
  description = "Determines if the ALB will be used internally only."
  type        = bool
  default     = false
}
