...
## Public Subnet
public_subnets = {
  "us-east-1a" = "10.150.4.192/27"
  "us-east-1b" = "10.150.4.224/27"
}
...
## Private Subnets
private_subnets = {
  "us-east-1a" = "10.150.4.0/26"
  "us-east-1b" = "10.150.4.64/26"
}
...
sap_security_groups = [
  ...
  },
  {
    ...
    is_scs : true,
    enable_sap_standard_http : true
    sap_base_cidr : ["10.150.4.0/25", "10.150.12.0/25"],
    sap_base_prefix : [],
    sap_control_cidr : ["10.150.4.0/25", "10.150.12.0/25"],
    sap_control_prefix : [],
    sap_router_sysnr : "3299"
