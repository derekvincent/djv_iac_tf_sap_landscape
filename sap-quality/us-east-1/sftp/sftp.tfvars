...
## EC2 Settings
##
ec2_ami = "ami-0742b4e673072066f" # Amazon Linux 2 AMI us-eaqst-1
...
security_group_ingress_rules = {
  ...
  ssh : {
    ...
    to_port : 22,
    protocol : "TCP",
    cidr_blocks : ["0.0.0.0/0", "10.150.4.0/22", "10.50.0.0/12", "10.150.12.0/22", "10.25.0.0/13", ],
    prefix_ids : [],
    security_groups : [],
...
sftp_shares = {
  bankOne : {
    username : "bankOne",
    bucket : "sapm-interfaces-bankOne",
    bucket_prefix : "/bankOne/process",
    mount : "process"
  },
  ONCall : {
    username : "oncall",
    bucket : "sapm-interfaces-oncall",
