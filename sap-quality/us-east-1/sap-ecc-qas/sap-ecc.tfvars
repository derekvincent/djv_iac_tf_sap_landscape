...
ebs_disk_layouts = {
  ...
  "sdh" : { "type" : "gp2", "size" : 35, "encrypted" : true, "description" : "ASE bins volume" },
  "sdi" : { "type" : "gp2", "size" : 250, "encrypted" : true, "description" : "ASE DB Data volume" },
  "sdj" : { "type" : "gp2", "size" : 250, "encrypted" : true, "description" : "ASE DB Data volume" },
  "sdk" : { "type" : "gp2", "size" : 250, "encrypted" : true, "description" : "ASE DB Data volume" },
  "sdm" : { "type" : "gp2", "size" : 100, "encrypted" : true, "description" : "ASE DB Log volume" },
  "sdo" : { "type" : "gp2", "size" : 300, "encrypted" : true, "description" : "SL Tools" },
}
...
volume_groups = [
  ...
  {
    name : "ase_data",
    devices : ["/dev/sdi", "/dev/sdj", "/dev/sdk"],
    logical_volumes : [
