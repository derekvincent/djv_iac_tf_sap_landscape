...
ebs_disk_layouts = {
  ...
  "sdi" : { "type" : "gp3", "size" : 250, "encrypted" : true, "description" : "ASE DB Data volume" },
  "sdj" : { "type" : "gp3", "size" : 250, "encrypted" : true, "description" : "ASE DB Data volume" },
  "sdk" : { "type" : "gp3", "size" : 250, "encrypted" : true, "description" : "ASE DB Data volume" },
  "sdl" : { "type" : "gp3", "size" : 250, "encrypted" : true, "description" : "ASE DB Data volume" },
  "sdm" : { "type" : "gp3", "size" : 100, "encrypted" : true, "description" : "ASE DB Log volume" },
  "sdn" : { "type" : "gp3", "size" : 100, "encrypted" : true, "description" : "ASE DB Log volume" },
  "sdo" : { "type" : "gp3", "size" : 500, "encrypted" : true, "description" : "SL Tools" },
  "sdp" : { "type" : "gp3", "size" : 700, "encrypted" : true, "description" : "SL Tools - temp " },
  "sdq" : { "type" : "gp3", "size" : 250, "encrypted" : true, "description" : "SL Tools - sapdblogs" },
  "sdr" : { "type" : "gp3", "size" : 250, "encrypted" : true, "description" : "SL Tools - sapdblogs" },
}
...
volume_groups = [
  ...
  },
  {
    ...
    devices : ["/dev/sdh"],
    logical_volumes : [
      { name : "ase", size : "100%FREE", mount : "/sybase/QAS/", fstype : "xfs" }
    ]
  },
  {
    name : "ase_logs",
    devices : ["/dev/sdm", "/dev/sdn"],
    logical_volumes : [
      { name : "logs", size : "100%FREE", mount : "/sybase/QAS/saplog_1", fstype : "xfs" }
    ]
  },
  {
    name : "ase_logs_mig",
    devices : ["/dev/sdq", "/dev/sdr"],
    logical_volumes : [
      { name : "logs_mig", size : "100%FREE", mount : "/sybase/QAS/saplog_2", fstype : "xfs" }
    ]
  },
  {
    name : "ase_data",
    ...
    logical_volumes : [
      { name : "data", size : "100%FREE", mount : "/sybase/QAS/sapdata_1", fstype : "xfs" }
    ]
  }
...
security_group_egress_rules = [
  {
    ...
    to_port : 0,
    protocol : "-1",
    cidr_blocks : ["10.150.4.0/22", "10.150.12.0/22", "10.50.0.0/12", "10.25.0.0/13"],
    prefix_ids : [],
    security_groups : [],
...
security_group_ingress_rules = [
  ...
  },
  {
    ...
    to_port : 22,
    protocol : "TCP",
    cidr_blocks : ["10.150.0.0/22", "10.50.0.0/12", "10.150.12.0/22", "10.25.0.0/13"],
    prefix_ids : [],
    security_groups : [],
